...
from events import GAME_STARTED_EVENT, MAIN_MENU_ENTERED_EVENT
...
class GameOver(GameState):
    ...
    def render_text(self):
        ...
        self.text_surface2 = font_small.render(
        ...
        self.screen.blit(self.text_surface1, ((
            SCREEN_WIDTH-self.text_rect1.width)/2, (SCREEN_HEIGHT-self.text_rect1.height)/2-self.text_rect2.height-50))
        self.screen.blit(self.text_surface2, ((
            SCREEN_WIDTH-self.text_rect2.width)/2, (SCREEN_HEIGHT-self.text_rect2.height)/2))
        self.screen.blit(self.text_surface3, ((
            SCREEN_WIDTH-self.text_rect3.width)/2, (SCREEN_HEIGHT-self.text_rect3.height)/2+self.text_rect2.height+20))
